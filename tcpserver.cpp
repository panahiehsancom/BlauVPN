...
void TCPServer::send(char *data, size_t size, std::string client_id)
{
...
void TCPServer::handle_read(const boost::system::error_code & erro, size_t bytes_transferred, std::shared_ptr<TCPClientEntity> client, std::string clientid)
{
    mtx_r.lock();
